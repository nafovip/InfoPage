			...
			<div class="_container">
				{isMobile ? (
					<div className="header__container">
						...
						<a class="header__button" href="https://app.uniswap.org/#/swap?outputCurrency=0xaf59f6613920d98ef64a133b21b28495a63e808f"><p class="button__text" target="_blank">buy now</p></a>
					</div>
				) : (
