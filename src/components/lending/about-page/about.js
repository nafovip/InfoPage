					...
					<div class="about-page__row">
						...
						<div class="row__descriptions">
							...
							<div class="about-page__description">
								...
								<p class="description_text">The donations will be sent to the most trusted and efficient funds raising money for Ukraine, such as <a href="https://prytulafoundation.org/en" target="_blank" style="color:#41B0F6;">Serhiy Prytula Foundation</a> or SaveLife.in.ua. </p>
							</div>
						</div>
					</div>
				) : (
					<div class="about-page__row">
						...
						<div class="row__descriptions">
							...
							<div class="about-page__description">
								...
								<p class="description_text"><Slide right duration={2000}>The donations will be sent to the most trusted and efficient funds raising money for Ukraine, such as <a href="https://prytulafoundation.org/en" target="_blank" style="color:#41B0F6;">Serhiy Prytula Foundation</a> or SaveLife.in.ua.</Slide></p>
							</div>
						</div>
					</div>
				)}
