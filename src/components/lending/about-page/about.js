				...
				<div className="about-page__row" id="off">
						...
						<div className="row__descriptions">
							...
							<div className="about-page__description">
								...
								<p className="description_text"><Slide right duration={2000}>The donations will be sent to the most trusted and efficient funds raising money for Ukraine, such as </Slide></p><a href="https://prytulafoundation.org/en" target="_blank" className="description_text"><Slide right duration={2000}> Serhiy Prytula Foundation or </Slide></p><a href="https://savelife.in.ua" target="_blank" className="description_text"><Slide right duration={2000}>SaveLife.in.ua.</Slide></a>
							</div>
						</div>
					</div>
			</div>
