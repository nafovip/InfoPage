				...
				<div className="about-page__row" id="off">
						...
						<div className="row__descriptions">
							...
							<div className="about-page__description">
								...
								<p className="description_text"><Slide right duration={2000}>The donations will be sent to the most trusted and efficient funds raising money for Ukraine, such as Serhiy Prytula Foundation or SaveLife.in.ua.</Slide></a>
							</div>
						</div>
					</div>
			</div>
